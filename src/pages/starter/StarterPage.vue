    ...
    <div class="page-header clear-filter">
      <div class="rellax-header rellax-header-sky" data-rellax-speed="-2">
        <parallax
          ...
          style="background-image: url('img/Background/Background.jpg')"
        ></parallax>
      </div>
      <div class="rellax-header rellax-header-buildings" data-rellax-speed="2">
        <parallax
          class="page-header-image"
          style="background-image: url('img/Background/PARTICLES.png')"
        ></parallax>
      </div>

      <div class="rellax-text-container rellax-text">
        <h1 class="h1-seo" data-rellax-speed="-2">Sling & Stone</h1>
      </div>

      <div class="rellax-text-container-h3 rellax-text">
        <h3 class="h3-seo" data-rellax-speed="2">We are under the maintenence</h3>
        <h3 class="h3-seo" data-rellax-speed="2">DIGITAL | PERFORMANCE | TECHNOLOGY</h3>
      </div>
    </div>
